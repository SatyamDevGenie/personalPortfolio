...
export const skills = [
  {
    ...
    skills: [
      ...
      },
      {
        name: "JQuery",
        image:
          "https://tse2.mm.bing.net/th?id=OIP.Dzoy6gZI4I-ec_sB3ev57gAAAA&pid=Api&P=0&h=180",
      },
      {
        name: "Vite",
        image:
  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        name: "Rest API",
        image:
          "https://tse2.mm.bing.net/th?id=OIP.L7QG86M28o5y1MmDDjTyCQAAAA&pid=Api&P=0&h=180",
      },
      {
        name: "Json Web Token",
        image: "https://iconape.com/wp-content/png_logo_vector/jwt.png",
      },
      {
        name: "Middleware",
        image:
          "https://www.logolynx.com/images/logolynx/5c/5cf0f9bb410f73a88ece7bc55f3088bc.jpeg",
      },
      {
        name: "Error Handling",
        image:
          "https://tse4.mm.bing.net/th?id=OIP.lU4PbZG7tlP8CRK1AzqLzgHaHa&pid=Api&P=0&h=180",
      },
    ],
  },
  {
    ...
    skills: [
      ...
      },
      {
        name: "MY SQL",
        image:
          "https://tse3.mm.bing.net/th?id=OIP.X9mlGdYRI3IbuvXPNS0IsQAAAA&pid=Api&P=0&h=180",
      },
    ],
  },
  {
    ...
    skills: [
      {
        name: "Git",
        image:
          "https://tse3.mm.bing.net/th?id=OIP.xcmDqjL3sDy11K6nrxxMAgHaHa&pid=Api&P=0&h=180",
      },
      {
        name: "GitHub",
        image:
      ...
      },
      {
        name: "Devtools",
        image:
          "https://logowik.com/content/uploads/images/google-chrome-dev4048.jpg",
      },
      {
        name: "Netlify",
        image:
      ...
      {
        name: "Render",
        image: "https://logoisus.com/product/render-logo-2/render.jpg",
      },
      {
        name: "Vercel",
        image: "https://vercel-quiz.netlify.app/resources/logo.png",
      },
    ],
  },
];
...
export const experiences = [
  {
    ...
    role: "Mern Stack Developer - Self Employed",
    company: "Freelancing",
...
export const education = [
...

  {
    ...
    school: "Sungrace English High School",
...
export const projects = [
...

  {
    ...
    description:
      "Fully functionality Web App with all basic ecommerce requirements along with the payment integration for the users 😇 ",
  ...
  },
  {
    ...
    description:
      "After login, user can book appointment with list of doctors, Doctor also schedule a appointment date to user also he can update his profile. Admin can also provide / add services to patients on the daily weekend basis.",
